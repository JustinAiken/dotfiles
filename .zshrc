...
if [[ "$(uname)" == "Darwin" ]]; then
  plugins=(ahn brew bundle capistrano gem git heroku jump kitchen knife knife-ssh meteor npm osx pod pow powify rails rvm spring_gem vagrant zeus zsh_reload zsh-syntax-highlighting)
else
